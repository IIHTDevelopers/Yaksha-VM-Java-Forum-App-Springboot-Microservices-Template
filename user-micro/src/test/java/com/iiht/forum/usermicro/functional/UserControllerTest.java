...
public class UserControllerTest {
	...
	public void user_TestUserRegistration() throws Exception {
		...
		yakshaAssert(currentTest(), 
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(userDetailDto))? "true" : "false"),	businessTestFile);
	...
	public void user_TestLoginSuccess() throws Exception {
		...
		yakshaAssert(currentTest(), 
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(MasterData.getUserDetailDto()))? "true" : "false"), 
					businessTestFile);
	}
